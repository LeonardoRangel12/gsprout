        ...
        <div class="container mx-auto py-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="max-w-lg">
                <div class="text-center mb-8">
                    <img src="https://i.imgur.com/QDzM74E.png" alt="Madeline" class="mx-auto" width="150" height="150">
                </div>
                ...
                <section>
                    ...
                    <p class="leading-relaxed mt-4 text-justify">Throughout our journey, we learned invaluable lessons about
                        ...
                        sophisticated algorithms to create a seamless user experience.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="leading-relaxed text-justify">Building G'sprout taught us a great deal about blockchain technology,
                        ...
                        engagement, and the importance of transparency and security in decentralized platforms.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="leading-relaxed mt-4 text-justify">Our platform was built using state-of-the-art blockchain technology,
                        ...
                        performance and reliability, ready to scale as our user base grows.</p>
                </section>
            ...
            <div class="max-w-lg">
                <section>
                    <div class="text-center mb-4">
                        <img src="https://i.imgur.com/qqeTACn.png" alt="Roadmap" class="mx-auto" width="200"
                            height="200">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="bg-gray-800 p-6 rounded-md">
                            ...
                            <p class="">G'sprout aims to revolutionize the gaming industry by providing a decentralized platform
                                ...
                                other external platforms.</p>
                        </div>
                        <div class="bg-gray-800 p-6 rounded-md">
                            <h3 class="text-xl font-bold mb-2">Sustainability Strategy</h3>
                            <ul>
                                <li><strong>Revenue Generation from Game Sales and Exchange Commissions</strong>
                                    <ul class="list-disc ml-8">
                                        <li>Our primary source of revenue will be from transaction fees on game sales
                                            and exchanges conducted on the G'sprout platform.</li>
                                        <li>We will implement competitive transaction fees to encourage user
                                            participation while ensuring sustainable revenue generation.</li>
                                        <li>As the platform grows, we will continuously optimize our fee structure to
                                            remain competitive and maximize revenue potential.</li>
                                    </ul>
                                </li>
                                <li><strong>Long-Term Integration with External Platforms</strong>
                                    <ul class="list-disc ml-8">
                                        <li>As part of our long-term strategy, we aim to integrate our game recognition
                                            system with external platforms such as Steam and Epic Games.</li>
                                        <li>This integration will enable users to transfer their existing game libraries
                                            to G'sprout and vice versa, providing added convenience and value.</li>
                                        <li>We will work towards establishing partnerships and collaborations with
                                            external platforms to facilitate this integration, ensuring a seamless
                                            experience for users across platforms.</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>

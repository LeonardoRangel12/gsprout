        ...
        <div class="container mx-auto py-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="max-w-lg space-y-8">
                ...
                <div class="rounded-lg shadow-lg bg-gray-800 p-6 text-white">
                    <img src="https://i.imgur.com/QDzM74E.png" alt="Madeline"
                    ...
                    <div class="p-4">
                        ...
                        <p class="leading-relaxed mt-4">Throughout our journey, we learned invaluable
                            ...
                            technology and sophisticated algorithms to create a seamless user experience.</p>
                    </div>
                </div>
                        ...
                        <ul class="list-disc pl-4">
                            ...
                            <li class="mb-4">
                                ...
                                <ul>
                                    ...
                                    <li>Implementation of security measures and data protection.</li>
                                    <li>Thorough testing to ensure security and performance.</li>
                                </ul>
                            </li>
                            <li class="mb-4">
            ...
            <div class="max-w-lg space-y-8">
                ...
                <div class="rounded-lg shadow-lg bg-gray-800 p-6 text-white">
                    <img src="https://media.webhelp.com/wp-content/uploads/2023/09/14154918/Gaming-Article-5-Post-GamesCom-1-.png"
                    ...
                    <div class="p-4">
                        ...
                        <p class="leading-relaxed">Building G'sprout taught us a great deal about
                            ...
                            about user experience design, community engagement, and the importance of transparency and
                ...
                <div class="rounded-lg shadow-lg bg-gray-800 p-6 text-white">
                    ...
                    <div class="p-4">
                        ...
                        <p class="leading-relaxed mt-4">Our platform was built using state-of-the-art
                            ...
                            optimization, we achieved high performance and reliability, ready to scale as our user base
                            grows.</p>
                    </div>
                </div>

                <!-- Section 6: Challenges We Faced -->
                <div class="rounded-lg shadow-lg bg-gray-800 p-6 text-white">
                    <img src="https://t4.ftcdn.net/jpg/07/09/79/63/360_F_709796397_xPl0MuZbFthnr07p7KWw5mqTyCmnAClj.jpg"
...
<style scoped>
/* Estilos Tailwind CSS o adicionales si es necesario */
</style>

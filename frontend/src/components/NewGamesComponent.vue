      ...
      <div class="container mx-auto py-12">
        <section class="game-list-section mb-8">
          ...
          <ul class="divide-y divide-gray-700">
            <li v-for="(game, index) in featuredGames.slice(0, 10)" :key="game._id" class="py-4 flex items-center justify-between">
              ...
              <div class="flex items-center">
                <span class="text-green-500 font-bold mr-4">{{ game.precio }}</span>
                <button type="submit" @click="switchToBuy(game._id)" class="py-1 px-2 bg-indigo-700 text-white font-bold rounded hover:bg-indigo-500">Comprar</button>
              </div>
            </li>
          </ul>
        </section>

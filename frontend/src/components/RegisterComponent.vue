        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
          <div class="flex-1">
            ...
            <div class="mt-8">
              ...
              <p class="mt-6 text-sm text-center text-gray-400">¿Ya tienes una cuenta? <a href="#" class="text-blue-500 focus:outline-none focus:underline hover:underline">Inicia sesión</a>.</p>
            </div>
          </div>
        </div>
      </div>
